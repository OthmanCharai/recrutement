    ...
    <div class="mbp_pagination">
        <ul class="page_navigation">
            ...
            <li class="page-item active" aria-current="page">
                <a class="page-link" href="{{ $paginator->nextPageUrl() }}">2 <span class="sr-only">@lang('pagination.next')</span></a>
            </li>
            @else
            <li class="page-item" aria-disabled="true"> <span class="page-link">@lang('pagination.next')</span></li>
            @endif
        </ul>
    </div>
