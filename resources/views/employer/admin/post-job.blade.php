			...
			<div class="row">
				<div class="col-sm-12 col-lg-4 col-xl-3 dn-smd">
					<div class="user_profile">
						<div class="media">
						  	<img src="{{ asset('images/team/e1.png') }}" class="align-self-start mr-3 rounded-circle" alt="e1.png">
						...
						<div class="row">
							...
							<div class="col-md-6 col-lg-12">
								<div class="my_profile_input form-group">
							    	...
							    	<input type="number" class="form-control" id="formGroupExampleInputDate" placeholder="22/05/2010">
								</div>
							</div>
