                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <ul>
                                                                    <li class="list-inline-item"><a href="{{ route('candidate.profile',$candidate->id) }}" data-toggle="tooltip" data-placement="top" title="Oglądaj"><span class="flaticon-eye btn btn-sm"></span></a></li>
                                                                    <li class="list-inline-item"><form method="POST" action="{{ route('candidate.destroy',$candidate->id) }}">@csrf @method('DELETE')<button class="btn btn-sm"  data-toggle="tooltip" data-placement="top" title="Usuń"><span class="flaticon-rubbish-bin"></span></button></form></li>
                                                                </ul>
                                                            </td>
                                                        </tr>
                                                        @endforeach
